...
ALTER FUNCTION mdm_internal.persist_entity(text, bigint, text, text) OWNER TO :"helper_owner";
ALTER FUNCTION mdm_internal.describe_entity(text, text) OWNER TO :"helper_owner";
COMMIT;
