...
archive=${1:-sql/archive/pg_mdm--0.14.0.sql}
...
assert set(helpers) == {
    'mdm_admin.verify_installation', 'mdm_internal.persist_entity', 'mdm_internal.persist_recompile', 'mdm_internal.describe_entity',
    ...
    'mdm_internal.persist_drop_entity', 'mdm_internal.persist_backfill_policy_case_opened_at',
    'mdm_internal.persist_refresh',
    'mdm_internal.persist_create_policy_binding',
    'mdm_internal.persist_replace_policy_binding', 'mdm_internal.persist_set_policy_binding_state',
    'mdm_internal.persist_set_case_controls',
    'mdm_internal.persist_policy_intent',
